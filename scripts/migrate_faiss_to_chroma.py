...
Migrates:
  - Memory vectors: data/memory_vectors/ -> misantropic_memories collection
  - RAG vectors:    data/rag/            -> misantropic_rag collection
